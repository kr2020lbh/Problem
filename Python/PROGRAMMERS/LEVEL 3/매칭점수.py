...
def solution(word, pages):
    ...
    url_pattern = re.compile('https.*com$')
    link_pattern = re.compile('<a.*>$')
    word = word.lower()
    ...
    for i in range(len(pages)):
        ...
        for j in range(len(lines)):
            ...
            if (re.search('<a.*">',line)):
                ...
                link = re.search('/.*"',a_tag).group()[2:-1]
